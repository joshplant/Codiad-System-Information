...
<table width="500px">
	...
	<tr><td>CPU Usage:</td><td><?php echo colorizeData(exec('top -bn1 | grep "Cpu(s)" | sed "s/.*, *\([0-9.]*\)%* id.*/\1/" | awk \'{print 100 - $1}\'')); ?></td></tr>
	<tr><td>Memory Usage:</td><td><?php echo colorizeData(round(shell_exec("free | grep Mem | awk '{print $3/$2 * 100.0}'"), 2)); ?></td></tr>
